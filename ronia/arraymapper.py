...
from ronia.utils import compose
...
class ArrayMapper:
    ...
    :class:`ronia.formulae.Formula` and ``x`` is an instance of :class:`ArrayMapper`.
...
def lift(f):
    ...
    .. code-block:: python
        ...
        from ronia.formulae import Scalar
