"""Plotting tools for Ronia models and formulae
...
def validation_plot(
    ...
    Parameters
    ----------
    model : ronia.bayespy.GAM | ronia.numpy.GAM
        Visualized model
...
def gaussian1d_density_plot(model: ronia.bayespy.GAM):
...
def gaussian2d_density_plot(model: ronia.bayespy.GAM, i, j):
...
def basis_plot(
        formula: ronia.formulae.Formula,
        grid_limits,
        input_maps,
        gridsize=20
):
